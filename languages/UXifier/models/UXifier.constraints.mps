...
<model ref="r:a56271cb-8db2-4d52-89e7-9a6c80c74584(UXifier.constraints)">
  ...
  <node concept="1M2fIO" id="77VjBUEWfE4">
    <property role="3GE5qa" value="styling" />
    <ref role="1M2myG" to="wi2d:3Sngu6AleB8" resolve="TextStyling" />
    <node concept="1N5Pfh" id="77VjBUEWfE5" role="1Mr941">
      <ref role="1N5Vy1" to="wi2d:3Sngu6AleB9" resolve="color" />
      <node concept="1dDu$B" id="77VjBUEWfFZ" role="1N6uqs">
        <ref role="1dDu$A" to="wi2d:7XyC30UC_lj" resolve="ThemeColor" />
      </node>
    </node>
    <node concept="1N5Pfh" id="77VjBUEWfGX" role="1Mr941">
      <ref role="1N5Vy1" to="wi2d:3Sngu6AleBb" resolve="font" />
      <node concept="1dDu$B" id="77VjBUEWfHY" role="1N6uqs">
        <ref role="1dDu$A" to="wi2d:7XyC30UF1q9" resolve="ThemeFont" />
      </node>
    </node>
  </node>
  <node concept="1M2fIO" id="7WrX6ZNFPjq">
  ...
  <node concept="1M2fIO" id="7WrX6ZNFKf5">
    <property role="3GE5qa" value="layout" />
    ...
    <node concept="1N5Pfh" id="7WrX6ZNFKgY" role="1Mr941">
      <ref role="1N5Vy1" to="wi2d:6lfKmmEvbcw" resolve="menuColor" />
      <node concept="1dDu$B" id="7WrX6ZNFKjO" role="1N6uqs">
        <ref role="1dDu$A" to="wi2d:7XyC30UC_lj" resolve="ThemeColor" />
      </node>
    </node>
  </node>
