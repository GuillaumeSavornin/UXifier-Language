                    ...
                    <Route exact path="/">
                        <Grid container maxWidth="'100%'" sx={{ p:2, alignItems:'start', margin:'auto'}}>
                            <Grid container xs={8}>
                                        ...
                                        <Grid container sx={{flexDirection: 'row'}}>                <Grid item md={12} lg={8}>
                                            ...
                                            <Grid item md={12} lg={4} sx={{flex:'auto'}}>
                                                <Grid margin={2} sx={{display:'flex'}}>
                                                    ...
                                                    })()} sx={{width:"auto", maxWidth:"100%", height:"auto", maxHeight:"100%", flex:'auto', filter: "contrast(5%)",
                                                        borderStyle:"solid", border:"solid black 1px", borderColor:"black", borderWidth:"5px", borderRadius:"5px", }}/>
                                                </Grid>
                                            </Grid>
                                        </Grid>
                                    </Paper>
                                ...
                                <Grid container margin={1}>
                                    <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                        <Typography gutterBottom sx={{ mb: 3, }} align={"left"} variant="h5" component="div">Activities</Typography>
                                        {(()=>{
                                            let array = [];
                                            for(let i = 0; i < 2; i++){
                                                array.push(<Grid container spacing={3}>
                                                        <Grid item>
                                                            <p style={{ color:themeColor_primary, fontFamily:themeFont_TimesNewRoman, fontSize:"xx-large",  }}>
                                                                <strong>{(()=>{
                                                            ...
                                                            <Grid item>
                                                                <p style={{ color:themeColor_rgbcolor, fontFamily:themeFont_CourierNew, fontSize:"medium ",  }}align={"justify"}>
                                                                    {(()=>{
                                            ...
                                            for(let i = 0; i < 3; i++){
                                                array.push(<div sx={{p: 2, display: "flex", flexDirection: "column", width: "100%"}}>
                                                        ...
                                                        <Collapse in={selectedCollapseIndex.includes(8+i)} timeout="auto" unmountOnExit>
                                                            ...
                                                            <div style={{ textAlign:"center" }}>
                                                                <Button target="_blank" style={{marginBottom : '10px',                          }} variant="outlined" href={(()=>{
                            ...
                            <Grid container xs={4}>
                                ...
                                <Grid container margin={1}>
                                    <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                        <a className="imageContainer" style={{position:"relative"}} href={(()=>{
                                            if(data.images && data.images[2] && data.images[2].linkUrl){
                                                return data.images[2].linkUrl
                                            }
                                            return "https://go.dev/"
                                        })()}><Box component="img" src=
                                            {(()=>{
                                                ...
                                                return "data:image/png;base64,"
                                            })()}sx={{height: 'auto', width:"100%", filter: "none(0%)"}} className="hoverImage" />
                                            <Button className="buttonImage" sx={{position:"absolute", top:"50%", left:"40%"}}>Visit content</Button>
                                        </a><Typography sx={{ml: 3, mr: 3,  }} align={"center"} variant="subtitle1" gutterBottom component="div">
                                        {(()=>{
    ...
    return (
        <Box sx={{ display: 'flex', width:'100%' }}>
            <AppBar position="absolute" open={false}>
                <Toolbar sx={{ height: '100px', backgroundColor: '#887755' }} >
                    <Typography component="h1" variant="h6" noWrap sx={{ flexGrow: 1, color:theme.palette.getContrastText('#887755'), fontFamily:themeFont_TimesNewRoman, fontSize:"xx-large", textAlign:"center", }}>GOPHER'S CV</Typography>
                </Toolbar>
            </AppBar>
...
const themeColor_primary="#ff5588"
const themeColor_lightgreen="#887755"
const themeColor_other="#229544"
