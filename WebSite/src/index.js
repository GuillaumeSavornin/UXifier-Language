    ...
    return (
        <Box sx={{ display: 'flex', width:'100%' }}>
            <AppBar position="absolute" open={false}>
                <Toolbar sx={{ height: '100px', backgroundColor: '#2EB67D' }} >
                    <Typography component="h1" variant="h6" noWrap sx={{ flexGrow: 1, color:theme.palette.getContrastText('#2EB67D'), fontSize:"medium ", textAlign:"left", }}>SINGLE LAYOUT CV</Typography>
                </Toolbar>
            </AppBar>
            ...
            <Box sx={{ width: '100%' }}>
                ...
                <Box flexDirection={"column"}>
                    <Grid container maxWidth="md" sx={{ p:2, alignItems:'start', margin:'auto'}}>
                        <Grid container margin={1}>
                            <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                <Grid container sx={{flexDirection: 'row'}}>            <Grid item sx={{alignSelf:'center'}} xs={12} sm={8}>
                                    <Typography gutterBottom sx={{ mb: 3, color:themeColor_secondary, fontFamily:themeFont_title_font, fontSize:"xx-large", }} align={"center"} variant="h5" component="div">
                                        {(()=>{
                                    ...
                                    <Typography gutterBottom sx={{ mb: 3, color:themeColor_light_text, fontSize:"large ", }} align={"center"} variant="h5" component="div">
                                        {(()=>{
                                            if(data.presentation){
                            ...
                            <Grid container margin={1}>
                                <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                    ...
                                    <div style={{alignSelf:"left", display:"flex"}}>
                                        <DirectionsCarFilledIcon sx={{ alignSelf:'center', color:themeColor_icon_color,  }} />
                                    ...
                                    <div style={{alignSelf:"left", display:"flex"}}>
                                        <CakeIcon sx={{ alignSelf:'center', color:themeColor_icon_color,  }} />
                                        <Typography sx={{ml: 1, mr: 1, textAlign:"left",  }} align={"justify"} variant="subtitle1" gutterBottom component="div">
                                            Age: {(()=>{
                                            if(data.additionalInformation){
                                    ...
                                    <div style={{alignSelf:"left", display:"flex"}}>
                                        <AddLocationIcon sx={{ alignSelf:'center', color:themeColor_icon_color,  }} />
                                        <Typography sx={{ml: 1, mr: 1, textAlign:"left",  }} align={"justify"} variant="subtitle1" gutterBottom component="div">
                                            Mobility places: {(()=>{
                                            if(data.additionalInformation){
                        ...
                        <Grid container xs={6}>
                            <Grid container margin={1}>
                                <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                    ...
                                    <div style={{alignSelf:"left", display:"flex"}}>
                                        <HomeIcon sx={{ alignSelf:'center', color:themeColor_icon_color,  }} />
                                        <Typography sx={{ml: 1, mr: 1, textAlign:"left",  }} align={"justify"} variant="subtitle1" gutterBottom component="div">
                                            {(()=>{
                                    ...
                                    {(()=>{
                                        ...
                                        for(let i = 0; i < 2; i++){
                                            array.push(<div sx={{p: 2, display: "flex", flexDirection: "column", width: "100%"}}>
                                                    ...
                                                    <div style={{ textAlign:"center" }}>
                                                        <ExpandMore sx={{ ml: 3, mr: 3}}
                                                                    expand={selectedCollapseIndex.includes(2+i)}
                                                                    onClick={() => {handleClickCollapse(2+i)}}
                                                                    aria-expanded={selectedCollapseIndex.includes(2+i)}
                                                                    aria-label="show more">
                                                            <ExpandMoreIcon sx={{  }}/>
                                                        </ExpandMore>
                                                    </div>
                                                    <Collapse in={selectedCollapseIndex.includes(2+i)} timeout="auto" unmountOnExit>
                                                        <Typography paragraph sx={{ ml: 3, mr: 3,  }} align={"justify"} gutterBottom component="div">
                                                            {(()=>{
...
const themeColor_primary="#2EB67D"
const themeColor_secondary="#ECB22E"
const themeColor_background_color="#e8eaed"
const themeColor_light_text="#636363"
const themeColor_icon_color="#E01E5A"


const themeFont_title_font="Aharoni"


const theme_squareSections = false
const theme_shadowLevel = 3
document.getElementsByTagName("body")[0].style.backgroundColor = "#e8eaed";
