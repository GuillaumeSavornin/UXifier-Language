        ...
        <Box sx={{ display: 'flex' }}>
            <AppBar position="absolute" open={open}>
                <Toolbar sx={{ pr: '24px', backgroundColor: '#1d77db' }} >
                    ...
                    <Typography component="h1" variant="h6" noWrap sx={{ flexGrow: 1, color:theme.palette.getContrastText('#1d77db'), }}>SIMPLE CV</Typography>
                </Toolbar>
            </AppBar>
                            ...
                            <Grid container margin={1}>
                                <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                    <Grid container sx={{flexDirection: 'row'}}>            <Grid item sx={{alignSelf:'center'}} xs={12} sm={8}>
                                        <Typography gutterBottom sx={{ mb: 3, color:themeColor_secondary, fontSize:"x-large", }} align={"center"} variant="h5" component="div">Presentation</Typography>
                                    ...
                                    {(()=>{
                                        ...
                                        for(let i = 0; i < 6; i++){
                                            array.push(<div sx={{p: 2, display: "flex", flexDirection: "column", width: "100%"}}>
                                                    ...
                                                    <div style={{ textAlign:"center" }}>
                                                        <ExpandMore sx={{ ml: 3, mr: 3}}
                                                                    expand={!selectedCollapseIndex.includes(4+i)}
                                                                    onClick={() => {handleClickCollapse(4+i)}}
                                                                    aria-expanded={!selectedCollapseIndex.includes(4+i)}
                                                                    aria-label="show more">
                                                            <ExpandMoreIcon sx={{  }}/>
                                                        </ExpandMore>
                                                    </div>
                                                    <Collapse in={!selectedCollapseIndex.includes(4+i)} timeout="auto" unmountOnExit>
                                                        <Typography paragraph sx={{ ml: 3, mr: 3,  }} align={"justify"} gutterBottom component="div">
                                                            {(()=>{
    ...
    return (
        <Box sx={{ display: 'flex', width:'100%' }}>
            <AppBar position="absolute" open={false}>
                <Toolbar sx={{ height: '100px', backgroundColor: '#1d77db' }} >
                    <Typography component="h1" variant="h6" noWrap sx={{ flexGrow: 1, color:theme.palette.getContrastText('#1d77db'), fontSize:"medium ", textAlign:"left", }}>SIMPLE CV</Typography>
                </Toolbar>
            </AppBar>
