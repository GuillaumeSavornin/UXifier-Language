        ...
        <Box sx={{ display: 'flex', width:'100%' }}>
            <AppBar position="absolute" open={false}>
                <Toolbar sx={{ height: '100px', }} >
                    <Typography component="h1" variant="h6" color="inherit" noWrap sx={{ flexGrow: 1 }}>SINGLE SECTION OF EACH</Typography>
                </Toolbar>
            </AppBar>
                    ...
                    <Grid container maxWidth="'100%'" sx={{ p:2, alignItems:'start', margin:'auto'}}>
                        <Grid container margin={1}>
                            <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                <Typography gutterBottom sx={{ mb: 3, color:themeColor_primary, }} align={"left"} variant="h5" component="div">Skills</Typography>
                                {(()=>{
                                    let array = [];
                                    for(let i = 0; i < 5; i++){
                        ...
                        <Grid container margin={1}>
                            <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                <Typography gutterBottom sx={{ mb: 3, color:themeColor_primary, }} align={"left"} variant="h5" component="div">Projects</Typography>
                                {(()=>{
                                    let array = [];
                                    for(let i = 0; i < 5; i++){
                                        array.push(<div sx={{p: 2, display: "flex", flexDirection: "column", width: "100%"}}>
                                                ...
                                                <div style={{ textAlign:"left" }}>
                                                    <ExpandMore sx={{ ml: 3, mr: 3}}
                                                                expand={selectedCollapseIndex.includes(10+i)}
                                                                onClick={() => {handleClickCollapse(10+i)}}
                                                                aria-expanded={selectedCollapseIndex.includes(10+i)}
                                                                aria-label="show more">
                                                        <ExpandMoreIcon sx={{  }}/>
                                                    </ExpandMore>
                                                </div>
                                                <Collapse in={selectedCollapseIndex.includes(10+i)} timeout="auto" unmountOnExit>
                        ...
                        <Grid container margin={1}>
                            <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                <Grid container sx={{flexDirection: 'row'}}>            <Grid item md={12} lg={8}>
                                    ...
                                    <Typography gutterBottom sx={{ mb: 3, fontSize: "medium ", }} align={"left"} variant="h5" component="div">
                                        {(()=>{
                                ...
                                {(()=>{
                                    ...
                                    for(let i = 0; i < 5; i++){
                                        array.push(<div sx={{p: 2, display: "flex", flexDirection: "column", width: "100%"}}>
                                                ...
                                                <div style={{ textAlign:"left" }}>
                                                    <ExpandMore sx={{ ml: 3, mr: 3}}
                                                                expand={!selectedCollapseIndex.includes(18+i)}
                                                                onClick={() => {handleClickCollapse(18+i)}}
                                                                aria-expanded={!selectedCollapseIndex.includes(18+i)}
                                                                aria-label="show more">
                                                        <ExpandMoreIcon sx={{  }}/>
                                                    </ExpandMore>
                                                </div>
                                                <Collapse in={!selectedCollapseIndex.includes(18+i)} timeout="auto" unmountOnExit>
                                                    <Typography paragraph sx={{ ml: 3, mr: 3,  }} align={"justify"} gutterBottom component="div">
                                                        {(()=>{
                                                            if(data.projectItems && data.projectItems[i] && data.projectItems[i].description){
                                                                return data.projectItems[i].description
                        ...
                        <Grid container margin={1}>
                            <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                <Typography gutterBottom sx={{ mb: 3, }} align={"left"} variant="h5" component="div">Additional Informations</Typography>
                                Driver's license: {(()=>{
...
const themeColor_primary="#00008011"




const theme_squareSections = true
const theme_shadowLevel = 2
