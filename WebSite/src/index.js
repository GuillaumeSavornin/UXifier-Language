        ...
        <Box sx={{ display: 'flex' }}>
            <AppBar position="absolute" open={open}>
                <Toolbar sx={{ pr: '24px', backgroundColor: '#1d77db' }} >
                    ...
                    <Typography component="h1" variant="h6" noWrap sx={{ flexGrow: 1, color:theme.palette.getContrastText('#1d77db'), }}>MULTI LAYOUT CV</Typography>
                </Toolbar>
            </AppBar>
        ...
        <Box sx={{ display: 'flex', width:'100%' }}>
            <AppBar position="absolute" open={false}>
                <Toolbar sx={{ height: '100px', backgroundColor: '#1d77db' }} >
                    <Typography component="h1" variant="h6" noWrap sx={{ flexGrow: 1, color:theme.palette.getContrastText('#1d77db'), fontSize:"medium ", textAlign:"left", }}>MULTI LAYOUT CV</Typography>
                </Toolbar>
            </AppBar>
