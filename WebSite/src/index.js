                                ...
                                <Grid container margin={1}>
                                    <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                        <Grid container sx={{flexDirection: 'row'}}>                <Grid item md={12} lg={8}>
                                            ...
                                            <Typography gutterBottom sx={{ mb: 3, color:themeColor_primary, fontFamily:themeFont_CourierNew, fontSize:"x-large", }} align={"left"} variant="h5" component="div">
                                                {(()=>{
            ...
            <Box sx={{ width: '100%' }}>
                ...
                <Box flexDirection={"column"}>
                    <Grid container maxWidth="'100%'" sx={{ p:2, alignItems:'start', margin:'auto'}}>
                        ...
                        <Grid container margin={1}>
                            <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                <Grid container sx={{flexDirection: 'row'}}>            <Grid item md={12}>
                                    <Typography gutterBottom sx={{ mb: 3, }} align={"left"} variant="h5" component="div">
                                        {(()=>{
                                            if(data.presentation){
                                                return data.presentation.name
