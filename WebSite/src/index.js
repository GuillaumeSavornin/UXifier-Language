        ...
        <Box sx={{ display: 'flex' }}>
            <AppBar position="absolute" open={open}>
                <Toolbar sx={{ pr: '24px', backgroundColor: '#1d77db' }} >
                    ...
                    <Typography component="h1" variant="h6" noWrap sx={{ flexGrow: 1, color:theme.palette.getContrastText('#1d77db'), }}>CV2</Typography>
                </Toolbar>
            </AppBar>
                ...
                <List component="nav">
                    <Link to="/">
                        <ListItemButton>
                            ...
                            <ListItemText sx={{}} primary="Presentation" />
                        </ListItemButton>
                    </Link>
                </List>
            </Drawer>
...
const themeColor_primary="#00796b"
const themeColor_primaryLight="#48a999"
const themeColor_primaryDark="#004c40"
const themeColor_secondary="#48a999"
