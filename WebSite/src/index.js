                    ...
                    <Route path="/Menu">
                        <Grid container maxWidth="'100%'" sx={{ p:2, alignItems:'start', margin:'auto'}}>
                            <Grid container xs={8}>
                                ...
                                <Grid container margin={1}>
                                    <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                        <Typography gutterBottom sx={{ mb: 3, color:themeColor_primary, fontFamily:themeFont_CourierNew, }} align={"left"} variant="h5" component="div">Experiences</Typography>
                                        {(()=>{
                                            let array = [];
                                            for(let i = 0; i < 5; i++){
                                                array.push(<p>{(()=>{
                                                ...
                                                array.push(<div sx={{p: 2, display: "flex", flexDirection: "column", width: "100%"}}>
                                                        ...
                                                        <div style={{ textAlign:"right" }}>
                                                            <ExpandMore sx={{ ml: 3, mr: 3}}
                                                                ...
                                                                <ExpandMoreIcon sx={{ color:theme.palette.getContrastText(themeColor_primary),  }}/>
                                                            </ExpandMore>
                                                        </div>
                                                        <Collapse in={!selectedCollapseIndex.includes(0+i)} timeout="auto" unmountOnExit>
                                                            ...
                                                            <div style={{ textAlign:"center" }}><Button style={{marginBottom : '10px'}} variant="outlined" href={(()=>{
                                                            ...
                                                            })()}> Go to project </Button></div>                        </Collapse>
                                                    </div>
                                                )
                                                if(i <3-1){
                            ...
                            <Grid container xs={4}>
                                ...
                                <Grid container margin={1}>
                                    <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%', background:themeColor_rgbcolor}}>
                                        <Box component="img" src=
                                            {(()=>{
                                                ...
                                                return "data:image/png;base64,"
                                            })()}sx={{height: 'auto', width:"100%", filter: "none(0%)"}}/><Typography sx={{ml: 3, mr: 3, color:theme.palette.getContrastText(themeColor_rgbcolor),  }} align={"center"} variant="subtitle1" gutterBottom component="div">
                                        {(()=>{
                                ...
                                <Grid container margin={1}>
                                    <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                        ...
                                        <div style={{alignSelf:"left", display:"flex"}}>
                                            <HomeIcon sx={{  }} />
                                            <Typography sx={{ml: 1, mr: 1, textAlign:"left", color:themeColor_other,  }} align={"justify"} variant="subtitle1" gutterBottom component="div">
                                                {(()=>{
...
const themeColor_rgbcolor="rgb(50, 168, 82)"
