        ...
        <Box sx={{ display: 'flex', width:'100%' }}>
            <AppBar position="absolute" open={false}>
                <Toolbar sx={{ height: '100px', }} >
                    <Typography component="h1" variant="h6" color="inherit" noWrap sx={{ flexGrow: 1 }}>SINGLESECTIONOFEACH</Typography>
                </Toolbar>
            </AppBar>
                                ...
                                {(()=>{
                                    ...
                                    for(let i = 0; i < 5; i++){
                                        array.push(<div sx={{p: 2, display: "flex", flexDirection: "column", width: "100%"}}>
                                                ...
                                                <div style={{ textAlign:"left" }}>
                                                    <ExpandMore sx={{ ml: 3, mr: 3}}
                                                                expand={!selectedCollapseIndex.includes(13+i)}
                                                                onClick={() => {handleClickCollapse(13+i)}}
                                                                aria-expanded={!selectedCollapseIndex.includes(13+i)}
                                                                aria-label="show more">
                                                        <ExpandMoreIcon sx={{  }}/>
                                                    </ExpandMore>
                                                </div>
                                                <Collapse in={!selectedCollapseIndex.includes(13+i)} timeout="auto" unmountOnExit>
                                                    <Typography paragraph sx={{ ml: 3, mr: 3,  }} align={"justify"} gutterBottom component="div">
                                                        {(()=>{
                                                            if(data.projectItems && data.projectItems[i] && data.projectItems[i].description){
                                                                return data.projectItems[i].description
