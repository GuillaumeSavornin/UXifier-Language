    ...
    return (
        <Box sx={{ display: 'flex' }}>
            <AppBar position="absolute" open={false}>
                <Toolbar sx={{ pr: '24px', }} >
                    <Typography component="h1" variant="h6" color="inherit" noWrap sx={{ flexGrow: 1 }}>CV TEST</Typography>
                </Toolbar>
            </AppBar>
                    ...
                    <Route path="/More details">
                        ...
                        <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
                            <Grid container spacing={3}>
                                <Grid item xs={12} md={8} lg={9}>
                                    <Paper sx={{p: 2, display: 'flex', flexDirection: 'column',}}>
                                        <Typography gutterBottom sx={{ mb: 3 }} align={"center"} variant="h5" component="div">Languages</Typography>
                                        {(()=>{
                                            let array = [];
                                            for(let i = 0; i < 2; i++){
                                                array.push(<Grid container spacing={3}>
                        ...
                        <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
                            <Grid container spacing={3}>
                                <Grid item xs={12} md={8} lg={9}>
                                    <Paper sx={{p: 2, display: 'flex', flexDirection: 'column',}}>
                                        <Typography gutterBottom sx={{ mb: 3 }} align={"right"} variant="h5" component="div">Languages</Typography>
                                        {(()=>{
                                            let array = [];
                                            for(let i = 0; i < 2; i++){
                                                array.push(<Grid container spacing={3}>
                ...
                <Box flexDirection={"column"}>
                    ...
                    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
                        <Grid container spacing={3}>
                            <Grid item xs={12} md={8} lg={9}>
                                <Paper sx={{p: 2, display: 'flex', flexDirection: 'column',}}>
                                    <Typography gutterBottom sx={{ mb: 3 }} align={"center"} variant="h5" component="div">Skills</Typography>
                                    {(()=>{
                                        let array = [];
                                        for(let i = 0; i < 2; i++){
                                            array.push([<Grid container spacing={3}>
