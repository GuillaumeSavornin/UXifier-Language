                            ...
                            <Grid container margin={1}>
                                <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%', background:themeColor_secondary}}>
                                    <Grid container sx={{flexDirection: 'row'}}>            <Grid item md={12} lg={8}>
                                        ...
                                        <Typography gutterBottom sx={{ mb: 3, fontSize: "xx-small", color:theme.palette.getContrastText(themeColor_secondary), }} align={"left"} variant="h5" component="div">
                                            {(()=>{
                                        ...
                                        <Typography gutterBottom sx={{ mb: 3, color:theme.palette.getContrastText(themeColor_secondary), }} align={"left"} variant="h5" component="div">
                                            {(()=>{
                                                if(data.presentation){
                            ...
                            <Grid container xs={8}>
                                <Grid container margin={1}>
                                    <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%', background:themeColor_primary}}>
                                        <Grid container sx={{flexDirection: 'row'}}>                <Grid item md={12} lg={8}>
                                            <Typography gutterBottom sx={{ mb: 3, color:theme.palette.getContrastText(themeColor_primary), fontFamily:themeFont_Bestfonteverforreports, }} align={"left"} variant="h5" component="div">Presentation</Typography>
                                            <Typography gutterBottom sx={{ mb: 3, fontSize: "medium ", color:theme.palette.getContrastText(themeColor_primary), fontFamily:themeFont_Bestfonteverforreports, }} align={"left"} variant="h5" component="div">
                                                {(()=>{
                                                    if(data.presentation){
                                                        return data.presentation.name
                                                    }
                                            ...
                                            <Typography gutterBottom sx={{ mb: 3, color:themeColor_niceColor, }} align={"left"} variant="h5" component="div">
                                                {(()=>{
                                                    if(data.presentation){
                                                        return data.presentation.catchPhrase
                                                    }
                                ...
                                <Grid container margin={1}>
                                    <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%', background:themeColor_Greencustomcolor}}>
                                        ...
                                        {(()=>{
                                            ...
                                            for(let i = 0; i < 5; i++){
                                                array.push(<div sx={{p: 2, display: "flex", flexDirection: "column", width: "100%"}}>
                                                        <Typography sx={{ ml: 3, mr: 3, color:theme.palette.getContrastText(themeColor_Greencustomcolor), fontFamily:themeFont_Bestfonteverforreports,  }} variant="h6" gutterBottom component="div">
                                                            {(()=>{
                                                        ...
                                                        <Typography sx={{ ml: 3, mr: 3, color:themeColor_primary,  }} variant="body2" gutterBottom component="div">
                                                            {(()=>{
                                                        ...
                                                        <Typography sx={{ ml: 3, mr: 3, color:themeColor_niceColor, fontFamily:themeFont_CourierNew,  }} variant="body1" gutterBottom component="div">
                                                            {(()=>{
                                                ...
                                                if(i <5-1){
                                                    array.push(<Divider sx={{ mb: 1,
                                                        background:themeColor_secondary,  }} variant="middle"/>)
                                                }
                                            }
                                            return array;
                                        })()}
                                        ...
                                        {(()=>{
                                            ...
                                            for(let i = 0; i < 2; i++){
                                                array.push(<div sx={{p: 2, display: "flex", flexDirection: "column", width: "100%"}}>
                                                        ...
                                                        <Typography sx={{ ml: 3, mr: 3, color:theme.palette.getContrastText(themeColor_primary),  }} variant="body1" gutterBottom component="div">
                                                            {(()=>{
                                                                if(data.projectItems && data.projectItems[i] && data.projectItems[i].corporation){
                                                                    return data.projectItems[i].corporation
                                                                }
