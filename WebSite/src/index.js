                ...
                <Switch>
                    <Route path="/Menu">
                            ...
                            <Grid container xs={8}>
                                <Grid container margin={1}>
                                    <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                        <Grid container sx={{flexDirection: 'row'}}>                <Grid item md={12} lg={4} sx={{flex:'auto'}}>
                                            <Grid margin={2} sx={{display:'flex'}}>
                                                ...
                                                })()} sx={{width:"auto", maxWidth:"100%", height:"auto", maxHeight:"100%", flex:'auto', filter: "opacity(75%)",
                                                    borderStyle:"solid", border:"solid black 1px", borderColor:themeColor_rgbcolor, borderWidth:"8px", borderRadius:"5px", }}/>
                                            </Grid>
                                        </Grid>
                                            <Grid item md={12} lg={8}>
                                                <Typography gutterBottom sx={{ mb: 3, fontSize:"xx-large", }} align={"left"} variant="h5" component="div">Presentation</Typography>
                                                <Typography gutterBottom sx={{ mb: 3, fontSize:"xx-large", }} align={"left"} variant="h5" component="div">
                                                    {(()=>{
                                                        if(data.presentation){
                                ...
                                <Grid container margin={1}>
                                    <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                        <Typography gutterBottom sx={{ mb: 3, fontSize:"xx-large", }} align={"left"} variant="h5" component="div">Projects</Typography>
                                        {(()=>{
                                            let array = [];
                                            for(let i = 0; i < 3; i++){
                                                array.push(<div sx={{p: 2, display: "flex", flexDirection: "column", width: "100%"}}>
                                                        ...
                                                        <Collapse in={selectedCollapseIndex.includes(5+i)} timeout="auto" unmountOnExit>
                                                            ...
                                                            <div style={{ textAlign:"left" }}>
                                                                <Button target="_blank" style={{marginBottom : '10px', fontSize:"xx-large",                          }} variant="outlined" href={(()=>{
                            ...
                            <Grid container xs={4}>
                                ...
                                <Grid container margin={1}>
                                    <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                        ...
                                        {(()=>{
                                            if(data.images && data.images[0] && data.images[0].legend){
                                                return data.images[0].legend
                                            }
                                        ...
                                        {(()=>{
                                            ...
                                            for(let i = 0; i < 5; i++){
                                                array.push([<Grid container spacing={3}>
                                                    ...
                                                    ,<p align={"justify"} style={{ ml:3, mr: 3, fontSize:"xx-large",  }}>
                                                        {(()=>{
                        ...
                        <Grid container maxWidth="sm" sx={{ p:2, alignItems:'start', margin:'auto'}}>
                            <Grid container margin={1}>
                                <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                    <Typography gutterBottom sx={{ mb: 3, fontSize:"xx-large", }} align={"left"} variant="h5" component="div">Additional Informations</Typography>
                                    Driver's license: {(()=>{
                    ...
                    <Route path="/Personal">
                        <Grid container maxWidth="lg" sx={{ p:2, alignItems:'start', margin:'auto'}}>
                            <Grid container margin={1}>
                                <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                    <Typography gutterBottom sx={{ mb: 3, fontSize:"medium ", }} align={"left"} variant="h5" component="div">Languages</Typography>
                                    {(()=>{
                                        let array = [];
                                        for(let i = 0; i < 5; i++){
                                            array.push(<Grid container spacing={3}>
                            ...
                            <Grid container margin={1}>
                                <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                    <Typography gutterBottom sx={{ mb: 3, fontSize:"medium ", }} align={"left"} variant="h5" component="div">Additional Informations</Typography>
                                    Driver's license: {(()=>{
                                    if(data.additionalInformation){
                                        return data.additionalInformation.driverLicense
                                    }
                            ...
                            <Grid container margin={1}>
                                <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                    <Typography gutterBottom sx={{ mb: 3, fontSize:"medium ", }} align={"left"} variant="h5" component="div">Projects</Typography>
                                    {(()=>{
                                        let array = [];
                                        for(let i = 0; i < 3; i++){
                                            array.push(<div sx={{p: 2, display: "flex", flexDirection: "column", width: "100%"}}>
                                                    <Typography sx={{ ml: 3, mr: 3, fontSize:"medium ",  }} variant="h6" gutterBottom component="div">
                                                        {(()=>{
                                                            if(data.projectItems && data.projectItems[i] && data.projectItems[i].title){
                                                                return data.projectItems[i].title
                                                            }
                                                    ...
                                                    <Typography sx={{ ml: 3, mr: 3, fontSize:"medium ",  }} variant="body2" gutterBottom component="div">
                                                        {(()=>{
                                                            if(data.projectItems && data.projectItems[i] && data.projectItems[i].date){
                                                                return data.projectItems[i].date
                                                            }
                                                    ...
                                                    <Collapse in={selectedCollapseIndex.includes(8+i)} timeout="auto" unmountOnExit>
                                                        ...
                                                        <div style={{ textAlign:"left" }}>
                                                            <Button target="_blank" style={{marginBottom : '10px', fontSize:"medium ",                      }} variant="outlined" href={(()=>{
                                                                if(data.projectItems && data.projectItems[i] && data.projectItems[i].url){
                                                                    return data.projectItems[i].url
                                                                }
                                                                return "https://miro.medium.com/max/1400/1*9D9u62mCYT7OhB9dNxXrkw.png"
                            ...
                            <Grid container margin={1}>
                                <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                    <Typography gutterBottom sx={{ mb: 3, fontSize:"medium ", }} align={"left"} variant="h5" component="div">Skills</Typography>
                                    {(()=>{
                                        let array = [];
                                        for(let i = 0; i < 3; i++){
                                            array.push([<Grid container spacing={3}>
                                                ...
                                                ,<p align={"justify"} style={{ ml:3, mr: 3, fontSize:"medium ",  }}>
                                                    {(()=>{
                                                        if(data.skillItems && data.skillItems[i] && data.skillItems[i].description){
                                                            return data.skillItems[i].description
                                                        }
            ...
            <Box sx={{ width: '100%' }}>
                ...
                <Box flexDirection={"column"}>
                    <Grid container maxWidth="'100%'" sx={{ p:2, alignItems:'start', margin:'auto'}}>
                        ...
                        <Grid container margin={1}>
                            <Paper square={theme_squareSections} elevation={theme_shadowLevel} sx={{p: 2, display: 'flex', flexDirection: 'column', width:'100%'}}>
                                <Typography gutterBottom sx={{ mb: 3, fontSize:"medium ", }} align={"left"} variant="h5" component="div">Contact</Typography>
                                <div style={{alignSelf:"left", display:"flex"}}>
                                    <HomeIcon sx={{  }} />
                                    <Typography sx={{ml: 1, mr: 1, textAlign:"left", fontSize:"medium ",  }} align={"justify"} variant="subtitle1" gutterBottom component="div">
                                        {(()=>{
                                            if(data.contactInformation){
                                                return data.contactInformation.address
                                            }
...
const themeColor_rgbcolor="#FF0000"


const themeFont_CourierNew="Courier New"
const themeFont_TimesNewRoman="Times New Roman"
